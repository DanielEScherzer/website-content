...
extensions:
  ...
  pygments: true
  toc: true
title: Pygments Highlighting for Markdown
---

# Pygments Highlighting for Markdown

This weekend, I published a new composer package that adds support for syntax
...
with the `.pygments-highlight-failed` selector.
...
[gh-repo]: https://github.com/DanielEScherzer/commonmark-ext-pygment-highlighter
[composer-package]: https://packagist.org/packages/danielescherzer/commonmark-ext-pygment-highlighter
